...
This Gradle module produces the iOS application bundle around the Compose Multiplatform UI exposed by `:livechatApp`.
...
- XCFramework for Xcode integration: run `./gradlew :livechatApp:assembleLiveChatComposeXCFramework` and consume the output from `../livechatApp/build/XCFrameworks`
