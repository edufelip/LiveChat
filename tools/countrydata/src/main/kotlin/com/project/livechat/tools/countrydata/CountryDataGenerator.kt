package com.project.livechat.tools.countrydata
...
fun main() {
    ...
    val records = locales.mapNotNull { isoCode ->
...
private fun List<CountryRecord>.toKotlinSource(): String {
    ...
    builder.appendLine("package com.project.livechat.composeapp.ui.features.onboarding.generated")
    builder.appendLine("import com.project.livechat.composeapp.ui.features.onboarding.CountryOption")
    builder.appendLine()
