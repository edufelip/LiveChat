...
data class SettingsStrings(
    ...
    val privacyPolicyUrl: String = "https://www.portfolio.eduwaldo.com/projects/live-chat/privacy_policy",
...
data class AccountStrings(
    ...
    val photoLabel: String = "Profile Photo",
    val photoMissing: String = "Add a photo",
    val photoChange: String = "Change photo",
    val photoSheetTitle: String = "Update profile photo",
    val photoSheetDescription: String = "Choose a new profile photo.",
...
data class OnboardingStrings(
    ...
    val welcomePrivacyUrl: String =
        "https://www.portfolio.eduwaldo.com/projects/live-chat/privacy_policy",
...
fun rememberLiveChatStrings(): LiveChatStrings {
    ...
    val account =
        AccountStrings(
            ...
            photoLabel = stringResource(Res.string.account_photo_label),
            photoMissing = stringResource(Res.string.account_photo_missing),
            photoChange = stringResource(Res.string.account_photo_change),
            photoSheetTitle = stringResource(Res.string.account_photo_sheet_title),
            photoSheetDescription = stringResource(Res.string.account_photo_sheet_description),
